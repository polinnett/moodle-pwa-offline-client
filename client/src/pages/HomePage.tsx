        ...
        >
          ...
          <div className="space-y-3">
            {[
              ...
              { step: '3', text: 'Периодически перезагружайте курсы – в них могут появляться изменения' },
              { step: '4', text: 'Откройте лекцию – текстовые материалы и видео доступны офлайн после скачивания' },
              { step: '5', text: 'Для расшифровки видео нажмите кнопку «Расшифровка текстом»' },
              { step: '6', text: 'Тесты доступны только онлайн – результаты отправляются на сервер' },
            ].map(item => (
